...
namespace Milestone_4_CST_150
{
    public partial class Form1 : Form
    {
        ...
        public Form1(string storeID, string employeeID)
        {
            InitializeComponent();
        ...
        {
            int choice = cboSort.SelectedIndex;
            switch (choice)
            {
                case 0:
                    txtDisplay.Text = inventory.sortInventoryByName();
                    break;
                case 1:
                    txtDisplay.Text = inventory.sortInventoryByPrice();
                    break;

                case 2:
                    txtDisplay.Text = inventory.sortInventoryByQuantity();
                    break;
                default:
                    break;
            }
